...
const PERFORMANCES = [
  { id: 'v1', title: 'Ashen Roads', venue: 'The Attic, Delhi', src: asset('videos/live-1.mp4'), poster: asset('gallery/hri.jpg') },
  { id: 'v2', title: 'Paper Boats', venue: 'Blue Tokai Sessions', src: asset('videos/live-2.mp4'), poster: asset('gallery/sha.jpg') },
  { id: 'v3', title: 'Static & Streetlight', venue: 'Summer House Cafe', src: asset('videos/live-3.mp4'), poster: asset('gallery/bhd.jpg') },
  { id: 'v4', title: 'Slow Weather', venue: 'Fandom Fest', src: asset('videos/live-4.mp4'), poster: asset('gallery/hin.jpg') },
]
